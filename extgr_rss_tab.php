...
if (class_exists('BP_Group_Extension')) : // Recommended, to prevent problems during upgrade or when Groups are disabled
    ...
    class BP_extgr_rss_tab_tab_Extension extends BP_Group_Extension {
        ...
        function __construct() {
            ...
            $nav_page_name = __('External Blogs', 'bp-groups-externalblogs');

            $this->name = !empty($nav_page_name) ? $nav_page_name : __('External Blogs', 'bp-groups-externalblogs');
            ...
            $this->admin_name = !empty($nav_page_name) ? $nav_page_name : __('External Blogs', 'bp-groups-externalblogs');
